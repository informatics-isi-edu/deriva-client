...
| `deriva-catalog-cli`         | Provides functions functions for creating, cloning, and dropping catalogs and catalog aliases. Also provides wrappers for making authenticated GET/PUT/POST/DELETE requests to _ERMrest_ catalogs.                                                                                                                                                                                                                        |                                                                                       
...
* A Python 3.8 or greater system installation is required. The latest 
